          ...
          <div class="col-8">
            <div class="icheck-primary">
              ...
              <label for="agreeTerms">
               concordo com todos esses <a href="#">termos</a>
              </label>
            </div>
          </div>
          <!-- /.col -->
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="idade" type="integer" class="form-control @error('idade') is-invalid @enderror" name="idade" value="{{ old('idade') }}" required autocomplete="idade" autofocus>
